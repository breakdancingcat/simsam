...
(function() {
  var Action, CloneAction, DeleteAction, GenericSprite, Interaction, OverlapInteraction, Rule, SpriteFactory, TransformAction, _ref, _ref1,
  ...
  DeleteAction = (function(_super) {
    ...
    function DeleteAction() {
      _ref1 = DeleteAction.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  window.saveSprites = function() {
    var masterObj, obj, objects, oneType, rule, ruleJSON, string, type, typeObjects, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref2, _ref3;
    masterObj = {};
    typeObjects = [];
  ...
  window.loadSprites = function(dataString) {
    var idx, imageObjects, img, imgSrc, inObject, iruleData, newSprite, obj, rule, ruleData, sprite, tmpList, typeFactory, typeObj, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref2, _ref3, _ref4, _ref5, _ref6;
    tmpList = [];
    window.spriteTypeList = [];
